...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:100,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": 升序排列",sSortDescending:":降序排列"},oPaginate:{sFirst:"",sLast:"",sNext:"",sPrevious:""},sEmptyTable:"没有数据",sInfo:"",sInfoEmpty:"没有数据",sInfoFiltered:"(从 _MAX_ 条中过滤)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"",sLoadingRecords:"加载中...",sProcessing:"处理中...",sSearch:"检索：",sUrl:"",sZeroRecords:"没有找到匹配的记录"},oSearch:g.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};S(p.defaults);p.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc","desc"],bSearchable:!0,bSortable:!0,bVisible:!0,fnCreatedCell:null,
...
g.extend(p.ext.classes,{sTable:"",sNoFooter:"",sPageButton:"",sPageButtonActive:"",sPageButtonDisabled:"",sStripeOdd:"",sStripeEven:"",sRowEmpty:"",sWrapper:"",sFilter:"",sInfo:"",sPaging:"",sLength:"",sProcessing:"",sSortAsc:"",sSortDesc:"",sSortable:"",sSortableAsc:"",
