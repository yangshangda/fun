...
<article class="page-container" display="none">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			...
			<br/><br/>
			<button type="button" class="btn btn-secondary radius" onclick="uploadImg();">上传图片A</button>
			<a hidden="ture" target="_blank" id="set_img"><img src="" id="img" width="200px" height="200px"/></a>
			<input style="width: 60px;height: 25px;" hidden="ture" id="delect" type="button" onclick="delectImg();" value="删除"/>
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			...
			<input type="text" class="input-text" placeholder="分数" id="title" name="title">
			<br/><br/>
			<button type="button" class="btn btn-secondary radius" onclick="uploadImg();">上传图片B</button>
			<a hidden="ture" target="_blank" id="set_img"><img src="" id="img" width="200px" height="200px"/></a>
			<input style="width: 60px;height: 25px;" hidden="ture" id="delect" type="button" onclick="delectImg();" value="删除"/>
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			...
			<input type="text" class="input-text" placeholder="分数" id="title" name="title">
			<br/><br/>
			<button type="button" class="btn btn-secondary radius" onclick="uploadImg();">上传图片C</button>
			<a hidden="ture" target="_blank" id="set_img"><img src="" id="img" width="200px" height="200px"/></a>
			<input style="width: 60px;height: 25px;" hidden="ture" id="delect" type="button" onclick="delectImg();" value="删除"/>
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			...
			<input type="text" class="input-text" placeholder="分数" id="title" name="title">
			<br/><br/>
			<button type="button" class="btn btn-secondary radius" onclick="uploadImg();">上传图片D</button>
			<a hidden="ture" target="_blank" id="set_img"><img src="" id="img" width="200px" height="200px"/></a>
			<input style="width: 60px;height: 25px;" hidden="ture" id="delect" type="button" onclick="delectImg();" value="删除"/>
		</div>
	</div>
	...
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>D分数：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" placeholder="" id="title" name="title">
		</div>
	</div>
