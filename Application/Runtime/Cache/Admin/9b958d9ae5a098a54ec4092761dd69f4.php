			...
			<tbody>
				<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="text-c">										
						...
						<td class="f-14 td-manage">
							<a class="btn btn-success radius edit" data-testid="<?php echo ($v["testid"]); ?>" data-questionid="<?php echo ($v["questionid"]); ?>" data-testnumber="<?php echo ($v["testnumber"]); ?>" data-testtitle="<?php echo ($v["testtitle"]); ?>" data-testimg="<?php echo ($v["testimg"]); ?>" data-atitle="<?php echo ($v["atitle"]); ?>" data-aimg="<?php echo ($v["aimg"]); ?>" data-ascore="<?php echo ($v["ascore"]); ?>" data-btitle="<?php echo ($v["btitle"]); ?>" data-bimg="<?php echo ($v["bimg"]); ?>" data-bscore="<?php echo ($v["bscore"]); ?>" data-ctitle="<?php echo ($v["ctitle"]); ?>" data-cimg="<?php echo ($v["cimg"]); ?>" data-cscore="<?php echo ($v["cscore"]); ?>" data-dtitle="<?php echo ($v["dtitle"]); ?>" data-dimg="<?php echo ($v["dimg"]); ?>" data-dscore="<?php echo ($v["dscore"]); ?>" id="edit" href="javascript:void(0);" data-toggle="modal" data-target="#modify">修改</a>
						</td>
